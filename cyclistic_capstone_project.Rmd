...
The dataframes used in this analysis are included in the project folder. Original data is publicly available at [this link](https://divvy-tripdata.s3.amazonaws.com/index.html).
...
**Offer targeted membership promotions to casual users.**
...
**Enhance the value of membership for leisure-focused users.**
...
**Analyze and improve station placement in high-leisure areas.**
